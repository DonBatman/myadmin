local admin_privilege = core.settings:get("myadmintools.admin_privilege") or "server"
...
core.register_alias("ut", "myadmintools:ut")
core.register_alias("utd", "myadmintools:utd")

core.register_on_punchnode(function(pos, node, puncher)
    local player_name = puncher:get_player_name()

    if not core.get_player_privs(player_name)[admin_privilege] then
        core.chat_send_player(player_name, "You don't have the required privilege for this tool.")
